...
dns_records = {
    'example.com':{
        ...
        dns.rdatatype.TXT: encrypted_data = f.encrypt(input_string.encode('utf-8')),  # Replace 'encrypted_secret_data' with your encrypted secret data
    ...
    'nyu.edu.': {
        dns.rdatatype.A: '192.168.1.106',
        #dns.rdatatype.TXT: encrypt_with_aes(input_string, password, salt),  # Replace 'encrypted_secret_data' with your encrypted secret data
        dns.rdatatype.MX: [(10, 'mxa-00256a01.gslb.pphosted.com.')],
        dns.rdatatype.AAAA: '2001:0db8:85a3:0000:0000:8a2e:0373:7312',
        dns.rdatatype.NS: 'ns1.nyu.edu.',
    },
